...
def report_user_heatmap(
    ...
    return get_heatmap(db, category, kd_propinsi, kd_kabupaten, kd_kecamatan, kd_kelurahan)
...
def report_user_trend_contributor(
    ...
    return get_trend_contributor(db, category, start_date, end_date)
...
def report_user_total_by_date_last_14_days(
    ...
    return get_total_by_date_last_14_days(db, category, start_date, end_date, kd_propinsi, kd_kabupaten, kd_kecamatan,
                                          kd_kelurahan)
...
def report_user_total_by_sentiment(
    ...
    return get_total_by_sentiment(db, category, start_date, end_date, kd_propinsi, kd_kabupaten, kd_kecamatan,
                                  kd_kelurahan)
...
def report_user_desc_data(
    ...
    return get_desc_data(db, category, start_date, end_date, kd_propinsi, kd_kabupaten, kd_kecamatan, kd_kelurahan)
...
def report_user_total_by_sentiment(
    ...
    return get_sentiment_category(db, category, start_date, end_date, kd_propinsi, kd_kabupaten, kd_kecamatan,
                                  kd_kelurahan)
